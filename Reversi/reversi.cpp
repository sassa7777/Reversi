...
uint64_t revbit(uint64_t *put, uint64_t *playerboard, uint64_t *opponentboard) {
	uint64_t rev = 0, rev_, mask;
    rev_ = 0;
    mask = (*put << 8) & 0xffffffffffffff00;
