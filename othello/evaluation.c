...
int score_stone(uint64_t *playerboard, uint64_t *oppenentboard, uint64_t *mask) {
    int score = 0;
...
int score_putable(uint64_t *playerboard, uint64_t *oppenentboard, uint64_t *legalboard) {
    int score = 0;
...
int countscore(uint64_t *playerboard, uint64_t *oppenentboard) {
    ...
    if(nowIndex+DEPTH >= 44) return (3*score_stone(playerboard, oppenentboard, &mask))+(55*score_fixedstone(*playerboard, *oppenentboard, &mask));
    return (3*score_stone(playerboard, oppenentboard, &mask))+(2*score_putable(playerboard, oppenentboard, &mask))+(55*score_fixedstone(*playerboard, *oppenentboard, &mask));
}
